package com.nandita.expensetracker.controller;
...
import com.nandita.expensetracker.model.Expenses;
import com.nandita.expensetracker.model.User;
import com.nandita.expensetracker.repository.BalanceRepo;
import com.nandita.expensetracker.repository.ExpensesRepo;
import com.nandita.expensetracker.repository.UserRepository;
@Controller
...
public ModelAndView displayLogout(ModelAndView modelAndView, com.nandita.expensetracker.model.User user) {
	modelAndView.addObject("user", user);
	modelAndView.setViewName("login");
	return modelAndView;
}
